...
function RegisterForm(){
    ...
    return(
            <div className="flex flex-col h-screen  items-center justify-between gap-48 p-2 mb-4 ">
            <form onSubmit={getReq}>
                <h2 className="text-3xl font-bold p-3">Register Here</h2>
